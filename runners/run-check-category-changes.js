...
const { main } = require('../actions/check-category-changes/index');

(async () => {
  try {
    console.log(new Date().toISOString(), 'Starting check-category-changes');
    ...
    console.log(new Date().toISOString(), 'Finishing check-category-changes');
  }
})();
